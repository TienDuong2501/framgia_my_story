    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                ...
                <div class="links">
                    <a href="https://laravel.com/docs">{{ trans('app.documentation') }}</a>
                    <a href="https://laracasts.com">{{ trans('app.laracast') }}</a>
                    <a href="https://laravel-news.com">{{ trans('app.news') }}</a>
                    <a href="https://forge.laravel.com">{{ trans('app.forge') }}</a>
                    <a href="https://github.com/laravel/laravel">{{ trans('app.github') }}</a>
                </div>
            </div>
        </div>
    </body>
