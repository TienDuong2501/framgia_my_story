...
$(document).ready(function () {
  $(function () {
    ...
    }).addClass("active").parent().parent().addClass("in").parent();i.is("li") && i.addClass("active");
  }), $(function () {
    $(window).bind("load resize", function () {
    ...
    var l = '[data-perform="panel-collapse"]';e(l).each(function () {
      var i = e(this),
          s = i.closest(".panel"),
          l = s.find(".panel-wrapper"),
          o = { toggle: !1 };l.length || (l = s.children(".panel-heading").nextAll().wrapAll("<div/>").parent().addClass("panel-wrapper"), o = {}), l.collapse(o).on("hide.bs.collapse", function () {
      ...
      i.preventDefault();var s = e(this).closest(".panel"),
          l = s.find(".panel-wrapper");l.collapse("toggle");
    });
  }(jQuery, window, document), function (e, i, s) {
    var l = '[data-perform="panel-dismiss"]';e(s).on("click", l, function (i) {
      function l() {
        var i = s.parent();s.remove(), i.filter(function () {
          var i = e(this);return i.is('[class*="col-"]') && 0 === i.children("*").length;
        }).remove();
      }i.preventDefault();var s = e(this).closest(".panel");l();
    });
...
}), $(".slimscrollright").slimScroll({ height: "100%", position: "right", size: "5px", color: "#dcdcdc" }), $(".slimscrollsidebar").slimScroll({ height: "100%", position: "right", size: "0px", color: "#dcdcdc" }), $(".chat-list").slimScroll({ height: "100%", position: "right", size: "0px", color: "#dcdcdc" }), $("body").trigger("resize"), $(".visited li a").click(function (e) {
  $(".visited li").removeClass("active");var i = $(this).parent();i.hasClass("active") || i.addClass("active"), e.preventDefault();
